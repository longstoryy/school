...
import { BookOpen, Users, Calendar, FileText, Bell, User } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">
            Welcome back, Professor {session.user?.name?.split(' ')[0] || 'Teacher'}! 👨‍🏫
          </h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">30 students • Room 201</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                    <div>
                      <h4 className="font-medium text-gray-900">Physics 101</h4>
                      <p className="text-sm text-gray-600">25 students • Lab 3</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                    <div>
                      <h4 className="font-medium text-gray-900">Calculus II</h4>
                      <p className="text-sm text-gray-600">35 students • Room 105</p>
                    </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Advanced Math</p>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Physics 101</p>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Calculus II</p>
